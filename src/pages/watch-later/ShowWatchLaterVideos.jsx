    ...
    return (
        <div className="showwatchlatervideos">
             <div className="showwatchlatervideos__container">
                ...
                <img src={imageURL(item && item.videoId)} className="showwatchlatervideos__img" alt=""/>
                </Link>
                <RiDeleteBin5Fill size={22} className="delete__btn" onClick={() => dispatch({ type: "REMOVE__WATCHLATER__VIDEOS", payload : item})}/>
